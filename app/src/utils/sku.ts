...
export function normalizeSkuOption(sku: Record<string, unknown>, index = 0): ProductSkuOption | null {
...
export function propertiesToLabel(properties?: Record<string, string>): string {
